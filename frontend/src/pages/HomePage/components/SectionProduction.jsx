...
const SectionProduction = () => {
    return (
        <section id="services" className="scroll-section h-screen w-full flex items-center justify-center bg-stone-950 relative overflow-hidden">
            ...
            <div className="max-w-6xl w-full px-10 grid grid-cols-1 md:grid-cols-3 gap-12 relative z-10">
                {[
                    ...
                    <div key={i} className="animate-item group p-10 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl hover:bg-white/10 transition-all duration-500 hover:-translate-y-2">
