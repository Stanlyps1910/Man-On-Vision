...
const SectionEntertainment = () => {
    return (
        <section className="scroll-section h-screen w-full flex items-center justify-center bg-stone-950 overflow-hidden relative">
            ...
            <div className="max-w-4xl text-center px-10 relative z-10">
                <h2 className="animate-item text-6xl md:text-9xl font-serif text-white tracking-tighter mb-8 italic">
                    Immersive <br /> <span className="text-orange-600">Experiences</span>
                </h2>
                <p className="animate-item text-stone-500 text-lg md:text-xl font-serif max-w-xl mx-auto border-t border-white/10 pt-8">
